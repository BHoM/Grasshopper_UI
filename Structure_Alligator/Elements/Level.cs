...
namespace BH.UI.Alligator.Structural.Elements
{
    public class CreateLevel : BHoMBaseComponent<Storey>
    {
        ...
        {
            get { return Alligator.Structural.Properties.Resources.BHoM_Level; }
        }
    }
    ...
    public class ExportLevel : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Internal_Icon_24x24
        {
            get { return Alligator.Structural.Properties.Resources.BHoM_Level_Export; }
        }
    }
    ...
    public class ImportLevel : ImportComponent<Storey>
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            if (DataUtils.Run(DA, 2))
            {
                ...
                if (app != null)
                {
                    ...
                    {
                        geometry.Add(GeometryUtils.Convert(Levels[i].GetPlane()));
                    }
        ...
        protected override System.Drawing.Bitmap Internal_Icon_24x24
        {
            get { return Alligator.Structural.Properties.Resources.BHoM_Level_Import; }
        }
    }
}

...
namespace BH.UI.Alligator.Structural.Elements
{
    public class ExportBar : GHE.Components.ExportComponent<BHE.Bar>
    {
        ...
        {
            get { return Alligator.Structural.Properties.Resources.BHoM_Bar_Export; }
        }
    ...
    //                List<BHE.Bar> bars = GHE.DataUtils.GetGenericDataList<BHE.Bar>(DA, 1).Select(x => x.GetShallowClone() as BHE.Bar).ToList();

...
namespace BH.UI.Alligator.Structural.Properties     //TODO: Needs to be adapted to the new Node constraint definition
{
    public class CreateBarRelease : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            BHSP.NodeConstraint rel = BH.Engine.Structure.Create.CreateNodeConstraint(name, fixities, new double[] { 0, 0, 0, 0, 0, 0 });

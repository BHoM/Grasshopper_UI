...
namespace Alligator.Base
{
    ...
    {
        public ToJSON() : base("ToJSON", "ToJSON", "Convert a BH.oM object to a JSON string", "Alligator", "Base") { }

        /// <summary> Icon (24x24 pixels)</summary>
        protected override System.Drawing.Bitmap Internal_Icon_24x24
        {
            get { return Alligator.Properties.Resources.BH.oM_ToJSON; }
        }
        ...
        {
            pManager.AddGenericParameter("BH.oM object", "object", "BH.oM object to convert", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(0, BHB.BH.oMJSON.WritePackage(objects.Cast<BHB.BHoMObject>().ToList(), password));
        }
    }
}

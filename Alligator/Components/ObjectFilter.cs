...
{
    // TODO Alligator.ObjectFilter is not supported by BH.oM.Base.FilterOption anymore. Implement back in BHoM or delete?
    
    
    //    public class ObjectFilter : GH_Component  //TODO: Is that still needed in BHoM 2.0?
    //    {
    ...
    //            List<BHoMObject> objects = DataUtils.GetGenericDataList<BHoMObject>(DA, 0);

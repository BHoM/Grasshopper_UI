...
namespace BH.UI.Alligator
{
    public static partial class Render
    {
        ...
        {
            pipeline.DrawArc(arc.ToRhino().Arc, bhColour, 3);
        }
        ...
        {
            pipeline.DrawCircle(circle.ToRhino(), bhColour, 3);
        }
        ...
        {
            pipeline.DrawCurve(ellipse.ToRhino().ToNurbsCurve(), bhColour, 3);
        }
        ...
        {
            pipeline.DrawCurve(polycurve.ToRhino(), bhColour, 3);
        }
        ...
        {
            pipeline.DrawPolyline(polyline.ControlPoints.Select(x => x.ToRhino()), bhColour, 3);
        }
        ...
        {
            pipeline.DrawBox(bbBox.ToRhino(), bhColour, 3);
        }

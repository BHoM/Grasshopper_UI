...
{
    public abstract class ImportComponent<T> : GH_Component where T : BH.oM.Base.IBase
    {
        ...
        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Elements", "Elements", "imported BH.oM objects", GH_ParamAccess.list);
            pManager.AddGeometryParameter("Geometry", "Geometry", "geometry of BH.oM objects", GH_ParamAccess.tree);
        }

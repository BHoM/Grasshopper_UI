...
namespace StadiaCrowdAnalytics_Alligator
{
    public class FramePlayer : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            folder = DA.BH_GetData(0, ref folder);
            DA.BH_GetData(1, ref analysedFrames);
            frameNumber = Convert.ToInt32(DA.BH_GetData(2, ref frameNumber));
            srf = DA.BH_GetData(3, ref srf);
            va = DA.BH_GetData(4, ref va);
            showMesh = DA.BH_GetData(5, ref showMesh);

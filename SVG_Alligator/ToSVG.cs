...
namespace BH.UI.Alligator.SVG
{
    public class TestComponent : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("C", "SVG", "SVG-string", GH_ParamAccess.item);
        }
        ...
        {
            pManager.AddTextParameter("SVG", "output", "", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            circle = DA.BH_GetData(0, ref circle);
